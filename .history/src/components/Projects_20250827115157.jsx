...
const Projects = () => {
  ...
  console.log("Projects data:", projects); // Log the projects data
  const uniqueProjects = Array.from(new Set(projects.map(p => p.id))) // Ensure unique projects
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-4">
                  {project.github_url && (
                    ...
                    >
                      <span className="h-5 w-5 mr-1">GitHub</span>
                      Code
                    </a>
                  )}
                  {project.live_url && (
