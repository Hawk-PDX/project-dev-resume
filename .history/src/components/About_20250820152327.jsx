      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-lg text-gray-600 leading-relaxed">
            {personalInfo?.summary || 'Full-stack developer passionate about creating innovative solutions.'}
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div>
              ...
              <div className="space-y-2 text-gray-600">
                <p><strong>Email:</strong> {personalInfo?.email || 'your.email@example.com'}</p>
                <p><strong>Location:</strong> {personalInfo?.location || 'Your City, State'}</p>
                <p><strong>Phone:</strong> {personalInfo?.phone || '+1 (555) 123-4567'}</p>
              </div>
            </div>
