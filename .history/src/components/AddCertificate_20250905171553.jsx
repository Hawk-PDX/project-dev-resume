    ...
    <div className="card" style={{ marginBottom: '2rem', maxWidth: '800px', margin: '2rem auto' }}>
      ...
      {isExpanded && (
        <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
          <div>
            <label htmlFor="entity" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
              Issuing Entity *
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="course" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
          ...
          <div>
            <label htmlFor="credential_id" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
              Credential ID
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="credit_hrs" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
              Credit Hours
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="issue_date" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
              Issue Date
            </label>
            <input
              type="date"
          ...
          <div>
            <label htmlFor="expiry_date" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'var(--text-color)', marginBottom: '0.25rem' }}>
              Expiry Date
            </label>
            <input
              type="date"
