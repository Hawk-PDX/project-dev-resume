...
const AddProject = ({ onProjectAdded, editProject, onCancelEdit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await projectsService.addProject(formData);
      ...
      setMessage('Error adding project: ' + (error.response?.data?.error || error.message));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="card" style={{ maxWidth: '600px', margin: '2rem auto' }}>
      <div style={{ padding: '2rem' }}>
        <h3 style={{ marginBottom: '1.5rem', textAlign: 'center' }}>Add New Project</h3>
